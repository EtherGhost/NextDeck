...
tmp_config="$(mktemp .clickable/nextdeck-desktop-test.XXXXXX.yaml)"
...
mapped = {
    "NEXTDECK_DESKTOP_DARK_MODE": os.environ.get("NEXTDECK_DESKTOP_DARK_MODE", "1"),
    "NEXTDECK_DESKTOP_TEST_AUTH": "1",
    "NEXTDECK_TEST_SERVER": first("NEXTDECK_TEST_SERVER", "NEXTCLOUD_TEST_SERVER", "NEXTNEWS_TEST_SERVER", "NEXTNOTES_TEST_SERVER"),
    "NEXTDECK_TEST_USERNAME": first("NEXTDECK_TEST_USERNAME", "NEXTCLOUD_TEST_USERNAME", "NEXTNEWS_TEST_USERNAME", "NEXTNOTES_TEST_USERNAME"),
    "NEXTDECK_TEST_APP_PASSWORD": first("NEXTDECK_TEST_APP_PASSWORD", "NEXTCLOUD_TEST_APP_PASSWORD", "NEXTNEWS_TEST_APP_PASSWORD", "NEXTNOTES_TEST_APP_PASSWORD"),
}
missing = [key for key in ["NEXTDECK_TEST_SERVER", "NEXTDECK_TEST_USERNAME", "NEXTDECK_TEST_APP_PASSWORD"] if not mapped[key]]
if missing:
